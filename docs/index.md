...
An application built from https://github.com/jdubrick-ai/apr7-newgitopsdoc-2-gitops will be stored in *quay.io/jdubrick-ai/apr7-newgitopsdoc-2* and deployed via Gitops. This application is accessible on port **8501**